/* eslint-disable */
// Generated by Wrangler by running `wrangler types apps/backend/worker-configuration.d.ts -c apps/backend/wrangler.jsonc` (hash: c7a9e27333d92d5f53e5bb92bdc841f6)
// Runtime types generated with workerd@1.20260301.1 2026-03-08 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "NewsIngestCoordinator";
	}
	interface Env {
		USAGE_KV: KVNamespace;
		AI_TELEMETRY: AnalyticsEngineDataset;
		AI_JOB_QUEUE: Queue;
		USAGE_SEED_QUEUE: Queue;
		FREE_TIER_RATE_LIMIT_BINDING: RateLimit;
		TRIAL_TIER_RATE_LIMIT_BINDING: RateLimit;
		SUBSCRIBER_TIER_RATE_LIMIT_BINDING: RateLimit;
		FREE_TIER_MODE: "false";
		NEWS_RSS_INGEST_ENABLED: "true";
		NEWS_RSS_SOURCES_PER_RUN: "36";
		NEWS_RSS_ITEMS_PER_SOURCE: "6";
		NEWS_RSS_ROTATION_WINDOW_SECONDS: "60";
		NEWS_RSS_FETCH_CONCURRENCY: "12";
		NEWS_INGEST_COORDINATOR: DurableObjectNamespace<import("./src/index").NewsIngestCoordinator>;
	}
}
