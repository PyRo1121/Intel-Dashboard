            ...
            <Show when={crm()?.ok !== false} fallback={
              ...
              <section class="grid gap-3 md:grid-cols-2 xl:grid-cols-6" data-testid="crm-summary-grid">
                <article class="intel-panel px-4 py-3" data-testid="crm-summary-total-users">
                  ...
                  <p class="mt-1 text-2xl font-semibold text-zinc-100">{formatNumber(crmDirectory()?.totalUsers)}</p>
                </article>
                <article class="intel-panel px-4 py-3" data-testid="crm-summary-subscribers">
                  ...
                  <p class="mt-1 text-2xl font-semibold text-zinc-100">{formatNumber(getCrmSubscriberCount(crmResult()))}</p>
                </article>
                <article class="intel-panel px-4 py-3" data-testid="crm-summary-mrr">
                  ...
                  <p class="mt-1 text-2xl font-semibold text-zinc-100">{formatUsd(getCrmMrrActiveUsd(crmResult()))}</p>
                </article>
                ...
                <article class="intel-panel px-4 py-3" data-testid="crm-summary-churn-30d">
                  ...
                  <p class="mt-1 text-2xl font-semibold text-rose-300">{formatPercent(crmCommandCenter()?.risk?.churnRate30dPct)}</p>
                </article>
                <article class="intel-panel px-4 py-3" data-testid="crm-summary-unique-users-24h">
                  ...
                  <p class="mt-1 text-2xl font-semibold text-zinc-100">{formatNumber(getCrmUniqueUsers24h(crmResult()))}</p>
                </article>
              </section>
