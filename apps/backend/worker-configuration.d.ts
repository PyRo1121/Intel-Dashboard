/* eslint-disable */
// Generated by Wrangler by running `wrangler types apps/backend/worker-configuration.d.ts -c apps/backend/wrangler.jsonc` (hash: 9f6354219a58c4c9ad300a9611b9ec5f)
