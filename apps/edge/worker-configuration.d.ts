/* eslint-disable */
// Generated by Wrangler by running `wrangler types apps/edge/worker-configuration.d.ts -c apps/edge/wrangler.toml -c apps/backend/wrangler.jsonc` (hash: 668b87a0515a89307e25b5b7ae403f41)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SCRAPE_INTERVAL_MS" | "SCRAPE_ROTATION_WINDOW_SECONDS" | "HOT_CHANNELS_PER_CYCLE">> {}
}
