...
export const SITE_NAME = "SentinelStream";
...
export const SITE_DESCRIPTION =
  "Real-time OSINT dashboard for SentinelStream with Telegram conflict tracking, military movement signals, and premium low-latency intelligence delivery.";
