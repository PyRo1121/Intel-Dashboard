...
export const AUTHENTICATED_BROWSER_ROUTES = Object.freeze([
  ...
  { path: "/my-alerts", heading: "My Alerts" },
...
export const BROWSER_METADATA_EXPECTATIONS = Object.freeze([
  ...
  {
    path: "/my-alerts",
    title: MY_ALERTS_TITLE,
    description: MY_ALERTS_DESCRIPTION,
    canonicalHref: siteUrl("/my-alerts"),
    robotsPattern: /noindex,nofollow/i,
  },
  {
    path: "/telegram",
...
export const APP_ROUTE_FILE_CLASSIFICATION = Object.freeze({
  ...
  "my-alerts.tsx": "browser-authenticated",
...
export const EDGE_API_ROUTE_CLASSIFICATION = Object.freeze({
  ...
  "/api/osint/source-history/*": "subscriber-osint-source-profile",
  "/api/telegram/dedupe-feedback": "owner-telegram-dedupe",
  "/api/telegram/source-history/*": "subscriber-telegram-source-history",
  "/api/telegram/source-leaderboard": "subscriber-telegram-leaderboard",
  "/api/telegram/stream": "session-telegram-stream",
  "/api/subscriber/alert-preferences": "subscriber-alert-preferences",
  "/api/subscriber/feed-preferences": "subscriber-preferences",
  "/api/subscriber/my-alerts": "subscriber-alerts",
  "/api/subscriber/my-alerts/read": "subscriber-alerts-mutation",
  "/api/subscriber/my-alerts/read-all": "subscriber-alerts-mutation",
