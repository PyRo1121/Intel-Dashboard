/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/worker-configuration.d.ts -c worker/wrangler.toml -c backend/wrangler.jsonc` (hash: 72528c10862057594aab1e632b8a178d)
