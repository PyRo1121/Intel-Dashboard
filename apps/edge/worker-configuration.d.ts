/* eslint-disable */
// Generated by Wrangler by running `wrangler types apps/edge/worker-configuration.d.ts -c apps/edge/wrangler.toml -c apps/backend/wrangler.jsonc` (hash: 072327708a23cc6274360ebdfea50434)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		SCRAPE_ROTATION_WINDOW_SECONDS: "60";
		HOT_CHANNELS_PER_CYCLE: "64";
		SCRAPE_FETCH_TIMEOUT_MS: "8000";
		SCRAPE_WORKER_CONCURRENCY: "48";
		CHANNEL_BUILD_CONCURRENCY: "40";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SCRAPE_INTERVAL_MS" | "SCRAPE_ROTATION_WINDOW_SECONDS" | "HOT_CHANNELS_PER_CYCLE" | "SCRAPE_FETCH_TIMEOUT_MS" | "SCRAPE_WORKER_CONCURRENCY" | "CHANNEL_BUILD_CONCURRENCY">> {}
}
