/* eslint-disable */
// Generated by Wrangler by running `wrangler types apps/edge/worker-configuration.d.ts -c apps/edge/wrangler.toml -c apps/backend/wrangler.jsonc` (hash: 72528c10862057594aab1e632b8a178d)
