---
name: flight-tracker
description: For aviation, flights, squawks, and military aircraft questions, read the local aviation state file. Use read tool with path /home/pyro1121/.openclaw/workspace/skills/aviation-intel/state/latest-aviation.txt — updated every 30 min from OpenSky Network with emergency squawks, military callsigns, and high-value aircraft. Do NOT use exec or curl.
