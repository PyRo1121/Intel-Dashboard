...
- `worker/` - production edge gateway (`intel.pyro1121.com/*`), auth, asset serving, API orchestration, cache/scraper Durable Objects
- `backend/` - backend API worker (billing, source catalog, AI jobs, feed aggregation)
- `src/` - frontend application code (SolidStart)
