...
const CATEGORY_STYLES: Record<string, IntelCategoryStyle> = {
  ...
  en_analysis: { bg: "bg-amber-500/10", border: "border-amber-500/20", text: "text-amber-300" },
  ...
  iran_milblog: { bg: "bg-amber-600/10", border: "border-amber-600/20", text: "text-amber-200" },
