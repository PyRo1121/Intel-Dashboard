...
import { applyCorsHeaders, corsJson, privateApiJson, privateApiMethodNotAllowed } from "../src/private-api-headers.ts";

test("applyCorsHeaders mutates response headers with allowed origin values", () => {
