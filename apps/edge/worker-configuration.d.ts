/* eslint-disable */
// Generated by Wrangler by running `wrangler types apps/edge/worker-configuration.d.ts -c apps/edge/wrangler.toml -c apps/backend/wrangler.jsonc` (hash: 5678ed711d7d1da9e5b9651e66dbf37e)
// Runtime types generated with workerd@1.20260301.1 2026-03-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "IntelCacheDO" | "TelegramScraperDO";
	}
	interface Env {
		...
		SCRAPE_ROTATION_WINDOW_SECONDS: "20";
		HOT_CHANNELS_PER_CYCLE: "128";
		SCRAPE_FETCH_TIMEOUT_MS: "8000";
		SCRAPE_WORKER_CONCURRENCY: "50";
		CHANNEL_BUILD_CONCURRENCY: "50";
		...
		INTEL_CACHE: DurableObjectNamespace<import("./src/index").IntelCacheDO>;
		TELEGRAM_SCRAPER: DurableObjectNamespace<import("./src/index").TelegramScraperDO>;
		INTEL_BACKEND: Service<typeof import("../backend/src/index").default>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SCRAPE_INTERVAL_MS" | "SCRAPE_ROTATION_WINDOW_SECONDS" | "HOT_CHANNELS_PER_CYCLE" | "SCRAPE_FETCH_TIMEOUT_MS" | "SCRAPE_WORKER_CONCURRENCY" | "CHANNEL_BUILD_CONCURRENCY" | "TELEGRAM_HOT_CHANNELS">> {}
}
